...
public class USER_URL {
    ...
    public static final String USER_PRODUCT_DELETE_BY_ID = "/remove/users/{userId}/products/{productId}";
    ...
    public static final String USER_ADD_PRODUCT_WITH_ID = "/add/users/{userId}/products/{productId}";
